...
import com.lg.client.view.grid.GridDistrito;

public class UiDistrito extends UiFormMantenimiento implements KeyUpHandler,
		InterUiDistrito {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridDistrito grid;
