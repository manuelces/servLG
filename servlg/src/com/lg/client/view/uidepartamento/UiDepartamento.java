...
import com.lg.client.view.grid.GridDepartamento;

public class UiDepartamento extends UiFormMantenimiento implements
		KeyUpHandler, InterUiDepartamento {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridDepartamento grid;

	public UiDepartamento() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
