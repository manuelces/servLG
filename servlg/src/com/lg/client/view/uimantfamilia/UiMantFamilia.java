...
public class UiMantFamilia extends UiMantenimiento implements InterUiMantFamilia, KeyUpHandler{
	protected MTextBox txtId;
	protected MTextBox txtAbreviatura;
	protected MTextBox txtDescripcion;	
	protected FamiliaProxy bean;
	
	public UiMantFamilia(){
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
            txtId.setText(this.bean.getIdFamilia().toString());
	...
	public void setBean(FamiliaProxy bean) {
		this.bean = bean;
	}
