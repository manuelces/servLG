...
import com.lg.client.view.grid.GridSubFamilia;
import com.lg.client.view.uisubfamilia.InterUiSubFamilia;

public class UiSubFamilia extends UiFormMantenimiento implements KeyUpHandler,
		InterUiSubFamilia {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridSubFamilia grid;
