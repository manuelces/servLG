...
import com.lg.client.view.grid.GridProvincia;

public class UiProvincia extends UiFormMantenimiento implements KeyUpHandler,
		InterUiProvincia {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridProvincia grid;
