...
import com.lg.client.view.grid.GridSubElectro;
import com.lg.client.view.uisubelectro.InterUiSubElectro;

public class UiSubElectro extends UiFormMantenimiento implements KeyUpHandler,
		InterUiSubElectro {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridSubElectro grid;
