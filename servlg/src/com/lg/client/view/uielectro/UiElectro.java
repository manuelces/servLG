...
import com.lg.client.view.grid.GridElectro;

public class UiElectro extends UiFormMantenimiento implements
		KeyUpHandler, InterUiElectro {
	//private Label lblBuscar;
	private MSearchBox txtBuscar;
	//private FlexTable formBuscar;
	protected GridElectro grid;
