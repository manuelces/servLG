...
import com.lg.client.view.grid.GridEmpresaFabricante;


public class UiEmpresaFabricante extends UiFormMantenimiento implements KeyUpHandler, InterUiEmpresaFabricante {

    //private Label lblBuscar;
    private MSearchBox txtBuscar;
    //private FlexTable formBuscar;
    protected GridEmpresaFabricante grid;

    public UiEmpresaFabricante() {
        initComponents();
        initListener();
        initStyle();
        reCalcularWindows();
    ...
    private void initComponents() {
        ...
        grid = new GridEmpresaFabricante();
