...
import com.lg.client.view.grid.GridFamilia;

public class UiFamilia extends UiFormMantenimiento implements
		KeyUpHandler, InterUiFamilia {
	//private Label lblBuscar;
	private MSearchBox txtBuscar;
	//private FlexTable formBuscar;
	protected GridFamilia grid;
