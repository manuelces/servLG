...
import com.lg.client.view.grid.GridTipoServicio;


public class UiTipoServicio extends UiFormMantenimiento implements KeyUpHandler, InterUiTipoServicio {

    //private Label lblBuscar;
    private MSearchBox txtBuscar;
    //private FlexTable formBuscar;
    protected GridTipoServicio grid;

    public UiTipoServicio() {
        initComponents();
        initListener();
        initStyle();
        reCalcularWindows();
