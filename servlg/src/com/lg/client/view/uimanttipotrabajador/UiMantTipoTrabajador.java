...
public class UiMantTipoTrabajador extends UiMantenimiento implements
		InterUiMantTipoTrabajador, KeyUpHandler {
	protected MTextBox txtId;
	protected MTextBox txtAbreviatura;
	protected MTextBox txtDescripcion;
	protected TipoTrabajadorProxy bean;

	public UiMantTipoTrabajador() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
			txtId.setText(this.bean.getIdTipoTrabajador().toString());
	...
	public void setBean(TipoTrabajadorProxy bean) {
		this.bean = bean;
	}
