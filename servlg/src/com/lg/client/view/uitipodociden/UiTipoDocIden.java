...
import com.lg.client.view.grid.GridTipoDocIden;

public class UiTipoDocIden extends UiFormMantenimiento implements KeyUpHandler,
		InterUiTipoDocIden {

	private MSearchBox txtBuscar;
	protected GridTipoDocIden grid;

	public UiTipoDocIden() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
