...
import com.lg.client.view.grid.GridTipoTrabajador;

public class UiTipoTrabajador extends UiFormMantenimiento implements
		KeyUpHandler, InterUiTipoTrabajador {
	// private Label lblBuscar;
	private MSearchBox txtBuscar;
	// private FlexTable formBuscar;
	protected GridTipoTrabajador grid;

	public UiTipoTrabajador() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
