...
public class UiMantTipoServicio extends UiMantenimiento implements
		InterUiMantTipoServicio, KeyUpHandler {
	...
	protected TipoServicioProxy bean;

	public UiMantTipoServicio() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
	...
	private void initComponents() {
		...
		this.addWidget("CONCESIONARIO (*)", lstEmpresaFabricante);
	...
	private void initStyle() {
		lstEmpresaFabricante.setWidth("100%");
	}
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
			txtId.setText(this.bean.getIdTipoServicio().toString());
	...
	public void setBean(TipoServicioProxy bean) {
		this.bean = bean;
	}
