...
public class UiMantTipoDocumento extends UiMantenimiento implements
		InterUiMantTipoDocumento, KeyUpHandler {
	...
	protected TipoDocumentoProxy bean;

	public UiMantTipoDocumento() {
		initComponents();
		initListener();
		initStyle();
		reCalcularWindows();
	...
	public void setBean(TipoDocumentoProxy bean) {
		this.bean = bean;
	}
